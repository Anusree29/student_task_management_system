...
<script>
    $(function(){
        $('#create_new').click(function(){
            uni_modal('Add New Student',"manage_employee.php",'mid-large')
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Student Details',"manage_employee.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.view_data').click(function(){
            uni_modal('Student Details',"view_employee.php?id="+$(this).attr('data-id'),'mid-large')
        })
