...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | SDTMS</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'employees')? 'active' : '' ?>" href="./?page=employees"><i class="fa fa-user-tie"></i> Student</a>
                    </li>
                    <li class="nav-item">
